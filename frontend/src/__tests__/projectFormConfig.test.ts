...
describe("projectToFormValues", () => {
    test("maps flat primitive fields correctly", () => {
        const result = projectToFormValues({
            ...
            employees: [
                { id: 10, first_name: "Employee", last_name: "10", email: "e10@example.com" },
                { id: 11, first_name: "Employee", last_name: "11", email: "e11@example.com" },
            ],
    ...
    test("converts manager object to managerId string", () => {
        const result = projectToFormValues({
            ...
            comments: "",
            status: "Active",
            manager: { id: 5, name: "Alice Manager" },
            employees: [],
            start_date: "2026-03-01",
            end_date: "2026-03-31",
    ...
    test("converts employee objects to string ids", () => {
        const result = projectToFormValues({
            ...
            manager: { id: 3, name: "Manager 3" },
            employees: [
                { id: 10, first_name: "Bob",   last_name: "One",  email: "bob@example.com" },
                { id: 11, first_name: "Carol", last_name: "Two",  email: "carol@example.com" },
            ],
            start_date: "2026-03-01",
            end_date: "2026-03-31",
            security_level: "Internal",
